...
export const createOutfit = async (req: AuthRequest, res: Response) => {
  try {
    ...
    console.error("Error creating outfit:", error.message, error.stack);
...
export const getOutfits = async (req: AuthRequest, res: Response) => {
  try {
    ...
    console.error("Error fetching outfits:", error.message, error.stack);
    return res.status(500).json({ message: "server error", error: error.message });
  }
};
...
export const getOutfitById = async (req: AuthRequest, res: Response) => {
  try {
    ...
    console.error("Error fetching outfit by ID:", error.message, error.stack);
    return res.status(500).json({ message: "server error", error: error.message });
  }
};
...
export const updateOutfit = async (req: AuthRequest, res: Response) => {
  try {
    ...
    console.error("Error updating outfit:", error.message, error.stack);
    return res.status(500).json({ message: "server error", error: error.message });
  }
};
...
export const deleteOutfit = async (req: AuthRequest, res: Response) => {
  try {
    ...
    console.error("Error deleting outfit:", error.message, error.stack);
    return res.status(500).json({ message: "server error", error: error.message });
  }
};
...
export const getFeaturedOutfits = async (req: AuthRequest, res: Response) => {
  try {
    ...
    console.error("Error fetching featured outfits:", error.message, error.stack);
    return res.status(500).json({ message: "server error", error: error.message });
  }
};
...
export const getPublicOutfits = async (req: AuthRequest, res: Response) => {
  try {
    const result = await db
      .select()
      .from(outfits)
      .where(eq(outfits.visibility, "public"));
    return res.status(200).json({ outfits: result });
  } catch (error: any) {
    console.error("Error fetching public outfits:", error.message, error.stack);
    return res.status(500).json({ message: "server error", error: error.message });
  }
};
